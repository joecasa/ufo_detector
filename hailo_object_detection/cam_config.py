...
class CamConfig:
    def __init__(self, video_device: str, camera_settings: CameraSettings, v4l_settings: V4LSettings):
        ...
        self.capture = None
        print(f"Initializing camera configuration for video device: {self.video_device} with resolution {self.v4l_settings.width}x{self.v4l_settings.height} and pixel format {self.v4l_settings.pixel_format}")
